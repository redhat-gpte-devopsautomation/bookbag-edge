...
+
image:images/RedHatOpenShiftDashboard.png[/workshop/images/RedHatOpenShiftDashboard]
. Upon clicking the *Launcher Icon* you will see another login screen.
Click the *Log in with OpenShift* icon.
+
image:images/loginwithopenshift.png[/workshop/images/loginwithopenshift]
